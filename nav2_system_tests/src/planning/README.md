...
Component level tests are available that exercise the Planning Module Task Server API ``` nav2_behavior_tree::ComputePlan```. The intention is to develop standard tests that can be used across all planners.
