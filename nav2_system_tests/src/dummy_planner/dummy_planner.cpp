...
: Node("DummyPlanner")
{
  ...
  task_server_ =
    std::make_unique<nav2_behavior_tree::ComputePathToPosesTaskServer>(temp_node, false),
  task_server_->setExecuteCallback(
    std::bind(&DummyPlanner::ComputePathToPoses, this, std::placeholders::_1));

  // Start listening for incoming ComputePathToPoses task requests
  task_server_->start();
...
void
DummyPlanner::ComputePathToPoses(const nav2_behavior_tree::ComputePathToPosesCommand::SharedPtr cmd)
{
  ...
  nav2_behavior_tree::ComputePathToPosesResult result;
  // set succeeded
