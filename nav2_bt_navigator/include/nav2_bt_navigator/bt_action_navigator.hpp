...
#ifndef NAV2_BT_NAVIGATOR__BT_ACTION_NAVIGATOR_HPP_
#define NAV2_BT_NAVIGATOR__BT_ACTION_NAVIGATOR_HPP_
...
public:
   ...
   */
  virtual ~BtActionNavigator() = default;
    ...
    std::shared_ptr<nav2_util::OdomSmoother> odom_smoother) override
  {
    ...
    bt_action_server_ = std::make_unique<nav2_behavior_tree::BtActionServer<ActionT>>(
      ...
      std::bind(&BtActionNavigator::onGoalReceived, this, std::placeholders::_1),
      std::bind(&BtActionNavigator::onLoop, this),
      std::bind(&BtActionNavigator::onPreempt, this, std::placeholders::_1),
      std::bind(
        &BtActionNavigator::onCompletion,
...
#endif  // NAV2_BT_NAVIGATOR__BT_ACTION_NAVIGATOR_HPP_
