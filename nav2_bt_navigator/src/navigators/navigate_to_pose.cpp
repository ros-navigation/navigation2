...
bool
NavigateToPoseNavigator::onActivate()
{
  return true;
}

bool
NavigateToPoseNavigator::onDeactivate()
{
  return true;
}

bool
NavigateToPoseNavigator::onCleanup()
{
  goal_sub_.reset();
  self_client_.reset();
  return true;
...
PLUGINLIB_EXPORT_CLASS(nav2_bt_navigator::NavigateToPoseNavigator, nav2_core::Navigator)
