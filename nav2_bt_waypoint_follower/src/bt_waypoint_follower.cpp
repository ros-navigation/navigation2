...
BtWaypointFollower::BtWaypointFollower(bool use_bond)
...
BtWaypointFollower::on_configure(const rclcpp_lifecycle::State & /*state*/)
{
  ...
  action_server_ = std::make_unique<ActionServer>(
    ...
    "follow_waypoints", std::bind(&BtWaypointFollower::followWaypoints, this));
...
bool
BtWaypointFollower::loadBehaviorTree(const std::string & bt_xml_filename)
{
