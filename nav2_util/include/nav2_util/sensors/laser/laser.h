...
#ifndef NAV2_UTIL__LASER__LASER_H_
#define NAV2_UTIL__LASER__LASER_H_
...
{
  public:
    BeamModel(double z_hit, double z_short, double z_max, double z_rand, double sigma_hit,
...
{
  public:
    LikelihoodFieldModel(double z_hit, double z_rand, double sigma_hit, double max_occ_dist,
...
{
  public:
    LikelihoodFieldModelProb(double z_hit, double z_rand, double sigma_hit, double max_occ_dist,
...
#endif  // NAV2_UTIL__LASER__LASER_H_