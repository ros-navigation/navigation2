...
class BinaryFilterTFTestable : public nav2_costmap_2d::BinaryFilter
{
public:
  using BinaryFilter::maskCallback;
  int state() const {return binary_state_;}
};

TEST(BinaryFilterTF, StaleTransformPreservesState)
{
