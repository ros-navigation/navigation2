...
def generate_launch_description():
    ...
    pose = {
        'x': LaunchConfiguration('x_pose', default='2.12'),  # Warehouse: 2.12
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'keepout_nav2_params.yaml'),
    ...
    keepout_filter = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_dir, 'keepout_filter_launch.py')),
    )
