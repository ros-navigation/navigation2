...
def generate_launch_description():
    ...
    start_slam_toolbox_cmd = GroupAction(
        ...
        actions=[
            #this remappings are required and enough to have a slam season subscriebe/publish <namespace>/map,<namespace>/tf,<namespace>/map
            #otherwise <namespace>/slam_toolbox node subs/pubs /scan, /tf, /map, B#
            ...
            LogInfo(
                condition=UnlessCondition(has_slam_toolbox_params),
                msg = "has_slam_toolbox_params: False"
                                  
            ),

            LogInfo(
                condition=IfCondition(has_slam_toolbox_params),
                msg="has_slam_toolbox_params: True"
            )
        ]
    )
