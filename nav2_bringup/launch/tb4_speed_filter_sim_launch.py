...
def generate_launch_description():
    ...
    pose = {
        'x': LaunchConfiguration('x_pose', default='2.12'),  # depot: -8.0
        'y': LaunchConfiguration('y_pose', default='-21.3'),  # depoy: 0.0
        'z': LaunchConfiguration('z_pose', default='0.01'),
        'R': LaunchConfiguration('roll', default='0.00'),
        'P': LaunchConfiguration('pitch', default='0.00'),
        'Y': LaunchConfiguration('yaw', default='1.57'),  # depot: 0.0
    }
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map',
        default_value=os.path.join(bringup_dir, 'maps', 'warehouse.yaml'),  # Try depot.yaml!
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'speed_filter_nav2_params.yaml'),
    ...
    declare_world_cmd = DeclareLaunchArgument(
        'world',
        default_value=os.path.join(sim_dir, 'worlds', 'warehouse.sdf'),  # Try depot.sdf!
    ...
    speed_filter = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(launch_dir, 'speed_filter_launch.py')),
    )
