...
def generate_launch_description():
    ...
    start_localization_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(common.launch_dir, 'nav2_localization_launch.py')),
    ...
    start_navigation_cmd = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(os.path.join(common.launch_dir, 'nav2_navigation_launch.py')),
        launch_arguments={'namespace': common.namespace,
                          'use_sim_time': common.use_sim_time,
                          'autostart': common.autostart,
                          'params_file': common.params_file,
                          ...
                          'use_lifecycle_mgr': 'false',
                          'use_remappings': common.use_remappings,
