...
function(nav2_add_test target)
  if(COMMAND ament_add_ros_isolated_test AND "$ENV{RMW_IMPLEMENTATION}" STREQUAL "rmw_zenoh_cpp")
...
function(nav2_add_gtest target)
  if(COMMAND ament_add_ros_isolated_gtest AND "$ENV{RMW_IMPLEMENTATION}" STREQUAL "rmw_zenoh_cpp")
...
function(nav2_add_pytest_test target)
  if(COMMAND ament_add_ros_isolated_pytest_test AND "$ENV{RMW_IMPLEMENTATION}" STREQUAL "rmw_zenoh_cpp")
...
function(nav2_add_gmock target)
  if(COMMAND ament_add_ros_isolated_gmock AND "$ENV{RMW_IMPLEMENTATION}" STREQUAL "rmw_zenoh_cpp")
