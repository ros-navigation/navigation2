...
TEST(CriticTests, GoalAngleCriticSymmetricYawTolerance)
{
  ...
  generated_trajectories.yaws = xt::zeros<float>({1000, 30});
  costs = xt::zeros<float>({1000});
  CriticData data1 = {state, generated_trajectories, path, costs, model_dt, false, nullptr, nullptr, std::nullopt, std::nullopt};
  ...
  generated_trajectories.yaws = 3.14159f * xt::ones<float>({1000, 30});
  costs = xt::zeros<float>({1000});
  CriticData data2 = {state, generated_trajectories, path, costs, model_dt, false, nullptr, nullptr, std::nullopt, std::nullopt};
  ...
  generated_trajectories.yaws = xt::zeros<float>({1000, 30});
  costs = xt::zeros<float>({1000});
  CriticData data3 = {state, generated_trajectories, path, costs, model_dt, false, nullptr, nullptr, std::nullopt, std::nullopt};
