...
### Controller
 ...
 | visualize_cost_layer       | int    | Default: 0. Selects which cost layer to visualize when `visualize` is true. `0` shows the total cost across all critics, `1..N` selects an individual critic by index.                                                                                                   |
