 ...
 * Bounds the Euclidean nearest-point match with the trajectory's arc-length
 * to prevent jumping to a distant path segment brought spatially close by
 * path curvature (e.g. a U-turn).
