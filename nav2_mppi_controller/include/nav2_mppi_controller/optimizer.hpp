...
public:
  ...
  /**
   * @brief Get the collision status for trajectories for visualization
   * @return Optional vector of collision flags for each trajectory
   */
  const std::optional<std::vector<bool>> & getTrajectoriesInCollision() const
  {
...
protected:
  ...
  CriticData critics_data_ = {
    ...
    costs_, std::nullopt, settings_.model_dt, false, std::nullopt, nullptr, nullptr,
