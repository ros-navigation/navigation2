...
:trajectory_generator_name:
  ...
  |                | robot can follow from it's current pose and velocity. These trajectories   |
...
:critics:
  ...
  |                | trajectories according to it's simple criteria. The scores from each critic|
...
:publish_cost_grid_pc:
  ...
  |**default**     | false                                                                      |
  +----------------+----------------------------------------------------------------------------+
  |**description** | If true, publishes the ????? on the **cost_cloud** topic. This can be      |
  |                | visualized in RViz                                                         |
  +----------------+----------------------------------------------------------------------------+
