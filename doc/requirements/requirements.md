...
ME010 | Mission Execution.Feedback.Outputs.Mission Canceled | 1 | Upon receiving a cancellation command and canceling the mission, the Mission Execution module SHALL output a corresponding notification.
