...
| sleep_time_inbetween_waypoints | 5 | Amount of time in seconds for robot to sleep/wait after each waypoint is reached. If zero, robot will directly continue to next waypoint. |
