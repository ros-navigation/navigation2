...
void NavigateThroughPosesPanel::setupUI()
{
  ...
  connect(action_name_edit_, &QLineEdit::textChanged, this, &NavigateThroughPosesPanel::onActionNameChanged);
  ...
  connect(remove_pose_button_, &QPushButton::clicked, this, &NavigateThroughPosesPanel::onRemovePose);
