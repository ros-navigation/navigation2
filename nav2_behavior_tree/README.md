...
| IsBatteryLow | Condition | Checks if battery is low by subscribing to battery status topic and checking if battery percentage is below a specified minimum value. |
