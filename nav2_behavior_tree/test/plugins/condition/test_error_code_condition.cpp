...
public:
  void SetUp()
  {
    bt_node_ = std::make_shared<nav2_behavior_tree::ErrorCodeCondition>(
        "error_code_condition", *config_);
  }
...
protected:
  static std::shared_ptr<nav2_behavior_tree::ErrorCodeCondition> bt_node_;
};

std::shared_ptr<nav2_behavior_tree::ErrorCodeCondition>
    ErrorCodeConditionTestFixture::bt_node_ = nullptr;
