...
void TransformHandler::activate()
{
  if (is_active_) {
...
void TransformHandler::deactivate()
{
  if (!is_active_) {
...
void TransformHandler::waitForTransform()
{
  if (is_active_) {
...
void TransformHandler::startRobotTransform()
{
...
void TransformHandler::updateRobotPose(const geometry_msgs::msg::Pose & pose)
{
...
void TransformHandler::publishRobotTransform()
{
