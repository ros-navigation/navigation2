...
planner_server:
  ros__parameters:
    ...
    GridBased:
      ...
      retrospective_penalty: 0.02         # For Hybrid/Lattice nodes: penalty to prefer later maneuvers before earlier along the path. Saves search time since earlier nodes are not expanded until it's necessary
