...
AmclNode::laserReceived(sensor_msgs::msg::LaserScan::ConstSharedPtr laser_scan)
{
  ...
  std::shared_ptr<nav2_amcl::MotionModel> motion_model_= poly_loader.createSharedInstance(robot_model_type_);
  motion_model_->initialize(alpha1_, alpha2_, alpha3_, alpha4_, alpha5_,seperation_between_the_wheels_,cmd_vel_topic_);
...
AmclNode::initParameters()
{
  ...
  get_parameter("seperation_between_the_wheels", seperation_between_the_wheels_);
