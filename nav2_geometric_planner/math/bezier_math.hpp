...
#ifndef NAV2_GEOMETRIC_PLANNER__BEZIER_MATH_HPP_
#define NAV2_GEOMETRIC_PLANNER__BEZIER_MATH_HPP_
  ...
  double t)
{
  if (control_points.empty()) {
    throw std::invalid_argument("evaluateBezier: control_points must not be empty");
  }
...
#endif  // NAV2_GEOMETRIC_PLANNER__BEZIER_MATH_HPP_
