...
class BasicNavigator(Node):
    ...
    def backup(self, backup_dist=0.15, backup_speed=0.025, time_allowance=10, disable_collision_checking=False):
        ...
        goal_msg.time_allowance = Duration(sec=time_allowance)
        goal_msg.disable_collision_checking = disable_collision_checking
    ...
    def driveOnHeading(self, dist=0.15, speed=0.025, time_allowance=10, disable_collision_checking=False):
