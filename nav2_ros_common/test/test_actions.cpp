...
private:
  ...
  nav2::Subscription<std_msgs::msg::Empty>::SharedPtr reject_goal_subs_;
  nav2::Subscription<std_msgs::msg::Empty>::SharedPtr allow_goal_subs_;
...
// [AI generated] This test and the allow/reject publisher and subscriber
// were generated by AI and reviewed by the author
...
TEST_F(ActionTest, test_handle_cancel)
{
  ...
  // Wait for the cancellation to fully complete
  auto future_result = node_->action_client_->async_get_result(future_goal_handle.get());
  EXPECT_EQ(
    rclcpp::spin_until_future_complete(node_, future_result),
    rclcpp::FutureReturnCode::SUCCESS);
